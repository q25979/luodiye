...
commonObject.prototype = {
    ...
    renderPromote:function(){
        ...
        if(query.type == 1){
            ...
            var wx_text = '微信';
            var wx_logo = '<img src="./public/wx.gif">';
            var wx_logo_src = './public/wx.gif';
            var wx_url = 'weixin://';
        }else if(query.type == 0){
            var wxid = query.promote;
            var imageUrl = query.imageUrl;
            var wx_logo = '<img src="./public/qq.png">';
            var wx_logo_src = './public/qq.png';
            var wx_text = 'QQ';
        ...
        goWechat(wx_url,wxid);
        function goWechat(url,wxid){
    ...
    createBanner:function(){
      if(!!tel){
        ...
        div.style.backgroundImage = 'url(./public/tel-bg.png)';
